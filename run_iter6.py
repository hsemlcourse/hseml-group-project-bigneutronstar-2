...
HORIZON    = 24
THRESHOLD  = 0.002
TOP_K      = 50       # сколько признаков оставляем
MIN_TRADES = 100      # минимум сделок для выбора threshold
...
def evaluate_full(model, X_test, y_test, fut_rets_test,
    ...
    # оптимальный threshold — ищем по val, применяем к test
...
if __name__ == "__main__":
    ...
    # ── 2. Baseline: Stacking v1 (из итерации 4/5) ────────────────────────
    print("\n" + "─" * 65)
    ...
    # ── 4. Stacking v2 (balanced + LightGBM + top features) ───────────────
    print("\n" + "─" * 65)
